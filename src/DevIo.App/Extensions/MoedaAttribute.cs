...
namespace DevIo.App.Extensions
{
    ...
    public class MoedaAttributeAdapter : AttributeAdapterBase<MoedaAttribute>
    {
        ...
        {
            return "Moeda emm formato inválida";
        }
    }
    ...
    public class MoedaValidationAttributeAdapterProvider : IValidationAttributeAdapterProvider
    {
        ...
        {
            if (attribute is MoedaAttribute moedaAttribute) return new MoedaAttributeAdapter(moedaAttribute, localizer); 

            return _baseProvider.GetAttributeAdapter(attribute, localizer);
        }
    }
}
